    ...
    <div className="h-[calc(100vh-120px)] flex justify-center items-center ">
      <div className="w-full max-w-sm mx-auto bg-white rounded-md shadow-md pt-6 px-8 mb-4 pb-8">
        ...
        <div className="mb-4">
          ...
          <div>
            <button className="bg-blue-400 hover:bg-blue-700 text-white font-bold rounded focus:outline-none px-8">
              Register
            </button>
          </div>
        </form>
        <p className=" align-baseline font-medium mt-4 text-sm px-3 py-2">
        ...
        {/* Google Sign In */}
        <div className="mt-4">
            <button className=" rounded-sm w-full flex flex-wrap gap-1 items-center justify-center bg-slate-700 hover:bg-blue-700 text-white font-bold px-4 py-2 focus:outline-none">
